...
class TFMainViewController: UIViewController {
...
extension TFMainViewController: TFEmbededViewControllerDelegate {
...
extension TFMainViewController: CameraFeedManagerDelegate {
...
extension TFMainViewController {
    ...
    private func addPanGesture() {
        let panGesture = UIPanGestureRecognizer(target: self, action: #selector(TFMainViewController.didPan(panGesture:)))
