...
class TFEmbededViewController: UIViewController {
...
extension TFEmbededViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func displayStringsForResults(atRow row: Int) -> (String, String) {
        ...
        guard let tempResult = inferenceResult, !tempResult.inferences.isEmpty else {
